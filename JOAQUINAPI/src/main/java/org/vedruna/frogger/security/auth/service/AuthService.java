...
import org.vedruna.frogger.service.ScoreRepositoryI;
...
public class AuthService implements AuthServiceI {
    ...
    @Autowired
    private ScoreRepositoryI scoreRepositoryI;
    ...
    public AuthResponseDTO login(LoginRequestDTO request) {
        ...
        User user= (User) userRepo.findByUsername(request.getName()).orElseThrow();
